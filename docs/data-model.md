...
| ARB Reviews Completed | COUNT | Project Name | Project Name — TEXT · Review Date — DATE · ARR Produced — BOOLEAN · Review Outcome — SELECT (Endorsed, Endorsed with Recommendations, Not Endorsed) · Recommendations Issued — NUMBER · Stakeholder Notification — DATE · Evidence — TEXT |
